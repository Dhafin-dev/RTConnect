...
Fitur: Sistem Administrasi Warga RTConnect Terpadu
  ...
  Skenario: Warga berhasil mengajukan surat pengantar domisili dengan TTD digital
    ...
    Dan Warga memilih opsi "Tanda Tangan Digital (QR Code)"
  ...
  # ------------------------------------------------------------------
  Skenario: Ketua RT membubuhkan stempel digital QR Code pada berkas yang disetujui
    ...
    Maka sistem menyematkan QR Code verifikasi pada lembar PDF surat
  ...
  # ------------------------------------------------------------------
  Skenario: Warga mengunduh surat pengantar resmi berstempel QR Code
    ...
    Dan Dokumen dapat diverifikasi keasliannya melalui pemindaian QR Code
