...
2. Bagaimana merancang mekanisme pengesahan dokumen surat pengantar yang mendukung fleksibilitas tanda tangan digital dalam bentuk tempelan gambar serta tanda tangan basah fisik?
...
6. **Keabsahan Dokumen:** Tanda tangan digital disematkan dalam bentuk tempelan gambar tanda tangan digital resmi yang mengarah pada URL validasi keaslian dokumen pada basis data RTConnect.
...
5. Pada percabangan metode pengesahan:
   - **Tanda Tangan Digital:** Sistem menyematkan tempelan gambar tanda tangan digital resmi Ketua RT pada dokumen PDF resmi. Warga menerima notifikasi dan dapat langsung mengunduh berkas PDF berstempel digital dari sistem.
...
- **Main Flow:**
  ...
  4. Warga mengisi tujuan/keperluan surat dan memilih metode tanda tangan (Digital (Tempelan Gambar) / Basah).
...
- **Tabel `surat_final`:**
  ...
  - `signature_image_url` (VARCHAR(100) UNIQUE)
...
Feature: Pengesahan Surat Pengantar dengan Tanda Tangan Digital
  Sebagai Ketua RT
  Saya ingin membubuhkan tanda tangan digital dalam bentuk tempelan gambar pada surat yang telah disetujui
  Agar surat pengantar sah secara digital dan dapat segera diunduh oleh warga

  Scenario: Ketua RT berhasil memvalidasi dan menyematkan Tempelan Gambar Tanda Tangan pengesahan
    ...
    And Halaman menampilkan preview dokumen PDF resmi yang memuat tempelan gambar tanda tangan digital resmi
...
1. **Resolusi dan Skalabilitas Diagram:**
   ...
   *Solusi:* Diagram harus dipecah menjadi 2 atau 3 sub-diagram tematik:
   ...
   - Sub-proses C: Penerbitan Dokumen (Jalur Digital (Tempelan Gambar) vs Jalur Fisik Basah).
