...
- **PURPOSE:** Full-screen in-app rendering of the official letter PDF with option to download or verify QR code.
...
- **DATA REQUIRED:** Letter PDF stream URL and `qr_verification_token`.
