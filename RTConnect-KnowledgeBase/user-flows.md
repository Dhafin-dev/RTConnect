...
- **Decision 02 (If Setuju):** What is `metode_tanda_tangan`?
  - *Digital:* System prompts RT for security PIN confirmation -> System generates unique registered digital signature image overlay -> Embeds QR into final PDF -> Status becomes `Selesai` -> Citizen notified to download.
