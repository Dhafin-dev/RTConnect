...
- **Solution:** A centralized mobile client with two primary pillars:
  1. *Automated Administrative Letter Service:* Generative AI-assisted letter drafting with dual-mode verification (Verifiable Digital Tempelan Gambar Tanda Tangan vs. Physical Pen Signature). [CONFIRMED]
...
| **REQ-F-011** | Letters | Confirm Digital Signature (Tempelan Gambar Tanda Tangan Embedding) | Ketua RT | MUST | CONFIRMED |
...
FEAT-03: Letter Review & Approval Engine (RT Portal)
  ...
  ├── Sub-feat 03.4: Digital Signature (PIN Auth + Tempelan Gambar Tanda Tangan Generation)
      ...
      └────────────────────────────────────────────────────────────────────────────────────────┘
          ...
          (SCREEN-007: Form Buat)       (SCREEN-006: Riwayat)         (SCREEN-011: Tanya RT)                                               │
              ...
              [ Status = Diajukan ]                │                 ▼                     ▼                                │         [ Notif Warga ] [ Terminate ]
                      ...
                      │                            │                                                            │                       │
                      │                            │                                                            ▼                       ▼
                      │                            │                                                    [ Embed Signature Image ]       [ Print & Ink Sign ]
                      │                            │                                                            │                       │
                      │                            │                                                            ▼                       ▼
...
Phase 6: Digital (Tempelan Gambar) Signature & PDF Handling
...
dependencies:
  ...
  qr_flutter: ^4.1.0             # Tempelan Gambar Tanda Tangan rendering for verification
...
5. Digital signature workflow embeds verifiable tempelan gambar tanda tangan in the generated PDF.
